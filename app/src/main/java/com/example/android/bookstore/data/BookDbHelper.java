...
public class BookDbHelper extends SQLiteOpenHelper{
    ...
    private final static String SQL_CREATE_BOOKS_TABLE = "CREATE TABLE " + BookEntry.TABLE_NAME + "(" +
    ...
    private final static String SQL_DELETE_BOOKS_TABLE = "DROP TABLE IF EXISTS " + BookEntry.TABLE_NAME + ";";
